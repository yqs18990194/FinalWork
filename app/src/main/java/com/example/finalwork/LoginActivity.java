...
import com.example.finalwork.Util.ViewUtil;
import com.example.finalwork.bean.UserInfo;
import com.example.finalwork.database.UserDBHelper;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener,View.OnFocusChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb_verify = findViewById(R.id.rb_verify);
    ...
    private String[] typeArray = {"个人用户", "公司用户", "18990194"};
